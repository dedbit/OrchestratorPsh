...
$logFile = Join-Path $scriptRoot 'test-results.log'
$testEnvFile = Join-Path $scriptRoot 'test-environment.json'
$modulePath = Join-Path $scriptRoot 'ConfigurationPackage\ConfigurationPackage.psm1'
