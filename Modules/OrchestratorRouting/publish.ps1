# publish.ps1
# Script to publish the OrchestratorRouting package using the common Packaging module

$ArtifactsFeedName = "OrchestratorPshRepo"
$SecretName = "PAT"
$PackageName = "OrchestratorRouting"
...
$nuspecFilePath = Join-Path $basePath "OrchestratorRouting.nuspec"
